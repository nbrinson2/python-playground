...
player_names = ['B. Bello', 'J. Berrios', 'T. Bibee', 'P. Blackburn', 'K. Bradish', 'T. Bradley', 'H. Brown', 'G. Canning', 'D. Cease', 'A. Civale', 'R. Detmers', 'B. Elder', 'B. Garrett', 'L. Gilbert', 'L. Giolito', 'H. Greene', 'H. Harris', 'M. Kelly', 'Y. Kikuchi', 'G. Kirby', 'M. Kopech', 'D. Kremer',
                'P. Lopez', 'B. Miller', 'B. Miller', 'J. Musgrove', 'B. Ober', 'J. Oviedo', 'J. Paxton', 'F. Peralta', 'E. Perez', 'C. Quantrill', 'E. Rodriguez', 'P. Sandoval', 'J. Sears', 'K. Senga', 'E. Sheehan', 'B. Singer', 'B. Snell', 'R. Suarez', 'J. Teheran', 'M. Wacha', 'T. Walker', 'T. Wells', 'B. Woo', 'Y. Darvish', 'M. Manning', 'M. Lorenzen', 'N. Pivetta', 'S. Gray', 'T. Skubal', 'C. Sanchez', 'B. Pfaadt']
